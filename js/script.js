...
document.querySelector('.projects-grid')?.insertAdjacentHTML('beforeend', `<article class="project-card project-extra reveal" data-category="ia" data-project="discord-bot"><div class="project-visual visual-discord"><span class="visual-label">COMMUNITY AUTOMATION / 15</span><div class="discord-orb">D<span>↗</span></div><div class="discord-lines"><i></i><i></i><i></i></div><div class="discord-caption mono">BOT<br />MULTIFUNCIÓN</div></div><div class="project-meta"><span class="project-index">15</span><h3>Bot completo<br /><em>para Discord</em></h3><p>Bot multifunción para servidores de comunidad con moderación, gestión de usuarios, economía y tickets de soporte.</p><div class="project-tags"><span>Python</span><span>Discord API</span><span>Automatización</span></div><button class="project-open" data-open="discord-bot" aria-label="Ver detalles del bot de Discord">↗</button></div></article>`);
...
const projects = {
  ...
  universalworks: { kicker: '17 / Web multi-negocio', title: 'UniversalWorks', description: 'Plantilla web adaptable para más de 30 tipos de negocio, como talleres mecánicos, carpinterías, electricistas y otros servicios profesionales. Cada negocio puede presentar sus servicios con una presencia online clara y responsive.', tech: ['HTML5', 'CSS3', 'JavaScript', 'Responsive design'], live: 'https://byruby12.github.io/WebUniversal/', repo: 'https://github.com/ByRuby12/WebUniversal' }
};
