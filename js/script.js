...
if (projectCount) projectCount.firstChild.textContent = '09 ';
document.querySelector('[data-filter="all"] small')?.replaceChildren('16');
document.querySelector('[data-filter="web"] small')?.replaceChildren('12');
